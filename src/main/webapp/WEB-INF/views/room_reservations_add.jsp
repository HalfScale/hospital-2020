...
<t:system_page title="Registration">
	...
	<jsp:attribute name="scripts">
		<script
			src="${pageContext.request.contextPath}/resources/pages/room_reservation/js/room-reservations.add.js"></script>
	</jsp:attribute>
	...
	<jsp:body>
		<div class="mx-auto mt-4 w-50 shadow p-3 mb-5 bg-white rounded">
			...
			<form id="reservationForm" action="add/confirm" method="POST">
				<input type="hidden" class="hospitalRoom" name="hospitalRoom"/>
